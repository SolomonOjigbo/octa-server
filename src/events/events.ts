...
export const EVENTS = {
  ...
  STOCK_TRANSFER_STATUS_CHANGE: 'stock-transfer.status-change',
  ...
  POS_SESSION_SUMMARY: "posSession.summary",
  ...
  WAREHOUSE_INVENTORY_ADDED: "warehouse.inventoryAdded",
  WAREHOUSE_INVENTORY_REMOVED: "warehouse.inventoryRemoved",
  WAREHOUSE_INVENTORY_UPDATED: "warehouse.inventoryUpdated",
  WAREHOUSE_STOCK_ADDED: "warehouse.stockAdded",
  WAREHOUSE_STOCK_REMOVED: "warehouse.stockRemoved",
  WAREHOUSE_STOCK_UPDATED: "warehouse.stockUpdated",
  WAREHOUSE_STATUS_CHANGED: "warehouse.statusChanged",
  WAREHOUSE_INVENTORY_TRANSFERRED: "warehouse.inventoryTransferred",
  VARIANT_ATTRIBUTE_UPDATED: "variantAttribute.updated",
  VARIANT_ATTRIBUTE_CREATED: "variantAttribute.created",
  VARIANT_ATTRIBUTE_DELETED: "variantAttribute.deleted",
  VARIANT_ATTRIBUTE_OPTIONS_UPDATED: "variantAttribute.optionsUpdated",
  VARIANT_ATTRIBUTE_OPTIONS_DELETED: "variantAttribute.optionsDeleted",
  VARIANT_ATTRIBUTE_OPTIONS_CREATED: "variantAttribute.optionsCreated",
  VARIANT_ATTRIBUTE_OPTIONS_TOGGLED: "variantAttribute.optionsToggled",
  VARIANT_ATTRIBUTE_OPTIONS_SORTED: "variantAttribute.optionsSorted",
